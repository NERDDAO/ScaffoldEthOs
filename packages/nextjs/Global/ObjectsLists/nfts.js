    ...
    <a className={style.TokenObject} onClick={() => onClick && onClick(element)}>
      ...
      <div className={style.ObjectInfo}>
        <div className={style.ObjectInfoAndLink}>
          ...
          {!dualChainId && <a target="_blank" onClick={e => e.stopPropagation()} href={`https://${chainId === 4 ? 'testnets.' : ''}opensea.io/assets/${element.tokenAddress}/${element.tokenId}`}>Opensea</a>}
